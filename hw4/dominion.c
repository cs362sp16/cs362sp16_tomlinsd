...
int adventurerCard(struct gameState *state, int currentPlayer, int drawntreasure, int cardDrawn) {
  int z = 0;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return(adventurerCard(state, currentPlayer, drawntreasure, cardDrawn));
    case council_room:
